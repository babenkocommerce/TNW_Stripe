define([
  ...
  return Component.extend({
    ...
    placeOrderClick: function () {
      ...
      adapter.createPaymentMethodByCart({owner: self.getOwnerData()})
        .done(function (response) {
          ...
          adapter.createPaymentMethod({
            ...
            three_d_secure: {
              card: response.paymentMethod.id
            },
            redirect: {
          ...
          .done(function (response) {
            ...
            featherlight({
              iframe: response.paymentMethod.redirect.url,
              iframeWidth: '800',
              iframeHeight: '600',
              ...
              afterClose: function() {
                adapter.retrieveSource({
                  ...
                  if (result.paymentMethod.status === 'chargeable') {
                    self.setPaymentMethodToken(response.paymentMethod.id);
